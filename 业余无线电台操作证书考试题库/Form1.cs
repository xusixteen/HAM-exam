...
namespace 业余无线电台操作证书考试题库
{
    public partial class Form1 : Form
    {
        ...
        string[] question;
        string[] myanswer = new string[361];
        string[] right_answer = new string[361];
        string[] standard_answer_text = new string[361];
        string temp_answer;
        int index = 0;
...
[P]";
            //try
            //{
            //    StreamReader sr = new StreamReader(@"E:\业余无线电台操作证书考试题库A类（v171031）.txt", Encoding.UTF8);
            ...
            //    throw;
            //}
            question = str.Split(new string[] { "[I]","[Q]","[A]","[B]","[C]","[D]","[P]" },StringSplitOptions.None);
            Refresh_question(0);
            //for(int t = 0;t<361;t++)
            //{
            //  textBox2.AppendText(question[t*7+6]);
            //}

        }
        private void Refresh_question(int index)
        {
            standard_answer_text[index] = question[index * 7 + 3];//记录正确答案A选项
            int[][] randomlist = new int[24][] { new int[4] { 1 , 2 , 3 , 4 }, new int[4] { 1 , 2 , 4 , 3 },new int[4] { 1 , 3 , 2 , 4 },new int[4] { 1 , 3 , 4 , 2 },new int[4] { 1 , 4 , 2 , 3 },new int[4] { 1 , 4 , 3 , 2 },
                                           new int[4] { 2 , 1 , 3 , 4 }, new int[4] { 2 , 1 , 4 , 3 },new int[4] { 2 , 3 , 1 , 4 },new int[4] { 2 , 3 , 4 , 1 },new int[4] { 2 , 4 , 1 , 3 },new int[4] { 2 , 4 , 3 , 1 },
                                           new int[4] { 3 , 1 , 2 , 4 }, new int[4] { 3 , 1 , 4 , 2 },new int[4] { 3 , 2 , 1 , 4 },new int[4] { 3 , 2 , 4 , 1 },new int[4] { 3 , 4 , 1 , 2 },new int[4] { 3 , 4 , 2 , 1 },
                                           new int[4] { 4 , 1 , 2 , 3 }, new int[4] { 4 , 1 , 3 , 2 },new int[4] { 4 , 2 , 1 , 3 },new int[4] { 4 , 2 , 3 , 1 },new int[4] { 4 , 3 , 1 , 2 },new int[4] { 4 , 3 , 2 , 1 }};
            string[] right_answer_position = new string[24] { "A","A","A","A","A","A",
                                                                "B","B","C","D","C","D",
                                                                "B","B","C","D","C","D",
                                                                "B","B","C","D","C","D"};

            Random rand = new Random();
            int random_count = rand.Next(0, 24);

            textBox1.Text = "[I]" + question[index * 7 + 1] + "\r\n"
                           + "[Q]" + question[index * 7 + 2] + "\r\n\r\n"
                           + "[A]" + question[index * 7 + randomlist[random_count][0] + 2] + "\r\n\r\n"
                           + "[B]" + question[index * 7 + randomlist[random_count][1] + 2] + "\r\n\r\n"
                           + "[C]" + question[index * 7 + randomlist[random_count][2] + 2] + "\r\n\r\n"
                           + "[D]" + question[index * 7 + randomlist[random_count][3] + 2];
                    

            right_answer[index] = right_answer_position[random_count];   
        }
        private void button1_Click(object sender, EventArgs e)
        {
            textBox1.Focus();
            textBox1.SelectionStart = textBox1.Text.IndexOf( "[A]");
            textBox1.SelectionLength = textBox1.Text.IndexOf("[B]") - textBox1.Text.IndexOf("[A]");
        ...
        {
            textBox1.Focus();
            textBox1.SelectionStart = textBox1.Text.IndexOf("[B]");
            textBox1.SelectionLength = textBox1.Text.IndexOf("[C]") - textBox1.Text.IndexOf("[B]");
        ...
        {
            textBox1.Focus();
            textBox1.SelectionStart = textBox1.Text.IndexOf("[C]");
            textBox1.SelectionLength = textBox1.Text.IndexOf("[D]") - textBox1.Text.IndexOf("[C]");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            textBox1.SelectionLength = textBox1.Text.Length - textBox1.Text.IndexOf("[D]");
        ...
        {
            myanswer[index] = temp_answer;
            index = (index + 1) % 361;
            Refresh_question(index);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0;i < 361; i++)
            {
                if((!string.IsNullOrEmpty(myanswer[i])) &&(!string.IsNullOrEmpty(right_answer[i])))
                {
                    question_count++;
                    if(myanswer[i] != right_answer[i])
                    {
                        wrong_count++;
                        textBox2.AppendText(wrong_count.ToString() + ":" + question[i * 7 + 2] + "\r\n"
                                            + "Right:" + standard_answer_text[i] + "\r\n\r\n");                                         
                    }    
                }
            }
            percent = wrong_count / question_count * 100;
            label1.Text = wrong_count.ToString() + "/" + question_count.ToString() + "------正确率：" + percent.ToString() + "%";
        }
    }
}
